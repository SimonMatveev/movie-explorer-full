...
const PATCH_USER_ERR =
  'Переданы некорректные данные для редактирования профиля пользователя.';
const LOGIN_ERR = 'Неправильные почта или пароль';
const ADD_MOVIE_ERR = 'Переданы некорректные данные для добавления фильма.';
const DEL_MOVIE_NOT_FOUND_ERR = 'Фильма с переданным _id не существует.';
const DEL_MOVIE_NOT_OWN_ERR = 'Фильм не ваш!';
const DEL_MOVIE_WRONG_ID_ERR = 'Передан некорректный _id фильма.';
const DEL_MOVIE_VALIDATION_ERR = 'Переданы некорректные данные для удаления фильма.';
